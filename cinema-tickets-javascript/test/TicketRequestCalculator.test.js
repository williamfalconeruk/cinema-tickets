...
describe("TicketRequestCalculator  Adult Boundary Checks" , () => {
    ...
    it('is not a negative total of tickets', () =>  {
        ...
        var request = new TicketTypeRequest("ADULT", -1);
        var response =calculator.calculate(request);
        expect(response.messages).toContain("please request between 1 and 20 tickets");
    }
    )
    ...
    it('is not a number of tickets over 20', () =>  {
        ...
        var response = calculator.calculate(request);
        expect (response.messages).not.toContain("please request between 1 and 20 tickets")
    }
    )


    it('is a valid number of tickets at lowest', () =>  {
    ...
    test('is a valid number of tickets at lowest', () =>  {
